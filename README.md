...
<p align="center">
  ...
  <img alt="Languages" src="https://img.shields.io/github/languages/count/Sthaynny/VollMed?color=%235963C5" />
  <img alt="lastcommit" src="https://img.shields.io/github/last-commit/Sthaynny/VollMed?color=%235761C3" />
  <img alt="License" src="https://img.shields.io/github/license/Sthaynny/VollMed?color=%235E69D7" />
  <img alt="Issues" src="https://img.shields.io/github/issues/Sthaynny/VollMed?color=%235965E0">
...
```bash
# Clone Repositorio
$ git clone https://github.com/Sthaynny/VollMed.git
...
Cria um issue <a href="https://github.com/Sthaynny/VollMed/issues">nova issue</a>, será uma honra poder ajudá-lo a resolver e melhorar ainda mais nosso aplicativo.
...
- Para mais informações acesse o [Guia de contribuição](https://github.com/Sthaynny/VollMed/blob/main/.github/contributing.md)
